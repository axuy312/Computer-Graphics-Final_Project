...
void FilterProgram::doMainLoop() {
  ...
  // eanbleBlackscene
  GLint eBLoc = glGetUniformLocation(programId, "eanbleBlackscene");
  glUniform1f(eBLoc, ctx->eanbleBlackscene);
  // eanbleSpeed
  GLint spLoc = glGetUniformLocation(programId, "eanbleSpeed");
  glUniform1i(spLoc, ctx->eanbleSpeed);
  // colorBuffer
